...
module.exports = {
  ...
  write: function write(generator) {
    ...
    generator.fs.copy('.gitignore', '.gitignore');
    generator.fs.copy('settings.gradle', 'settings.gradle');
    generator.fs.copy('build.gradle', 'build.gradle');

    mkdirp('gradle/wrapper');
    generator.fs.copy('gradlew', 'gradlew');
    generator.fs.copy('gradlew.bat', 'gradlew.bat');
    generator.fs.copy('gradle/wrapper/gradle-wrapper.jar', 'gradle/wrapper/gradle-wrapper.jar');
    generator.fs.copy('gradle/wrapper/gradle-wrapper.properties', 'gradle/wrapper/gradle-wrapper.properties');
    ...
    generator.fs.copy('api/build.gradle', 'api/build.gradle');
